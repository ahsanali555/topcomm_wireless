// Freq_Est_Fitz.h: interface for the Freq_Est_Fitz class.
//
//////////////////////////////////////////////////////////////////////
#include "ctopcom.h"
#pragma once
/*! \file 
\brief Declaration of class Freq_Est_Fitz
*/
/*! \ingroup Synchronization
\brief Frequency Estimator based on Fitz algorithm.
...
public:
	...
	Freq_Est_Fitz(
		...
		const int J=2		//!< Number of branches
		);
