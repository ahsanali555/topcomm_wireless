// Gardner.h: interface for the Gardner class.
//
//////////////////////////////////////////////////////////////////////
#pragma once
/*! \file 
\brief Declaration of class Gardner
*/
/*! \ingroup Synchronization
\brief Closed-loop Garner timing synchronizer.

This class implements a Gardner closed loop timing recovery circuit. 
The sequence of samples \f$x_k\f$ at sample rate roughly \f$2/T\f$ enters an
interpolator AtoD whose sampling instant \f$\tau\f$ is controlled by the Gardner loop. 
...
per period provided to the circuit (usually 2 but it can be larger), 
